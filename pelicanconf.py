...
SITENAME = '{ Dicas de Javascript }'
SITEURL = 'http://dicasdejavascript.com.br'
...
STATIC_PATHS = ['pages/extra/CNAME', 'images', 'examples', 'pages/extra/custom.css', 'admin']
...
DEFAULT_ADSENSE = {
	...
	'adSlot' : {
		'top_responsible' : '3606923311',
		'rside_300x600' : '3175678472',
		'bottom_responsible' : '7166894378'
	}
}
